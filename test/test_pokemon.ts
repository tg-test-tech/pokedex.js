...
describe("Pokemon class (language: ja)", () => {
  ...
  describe("constructor", () => {
    it("initializes correct properties for ピカチュウ", () => {
      ...
      expect(pikachu.baseStats).to.have.all.keys("H", "A", "B", "C", "D", "S");
      expect(pikachu.eggGroup)
        .to.be.an("array")
        .that.has.lengthOf(2)
        .and.that.include("陸上")
        .and.that.include("妖精");
      expect(pikachu.megaEvolution).to.be.undefined;
    });
    ...
    it("initializes correct properties for リザードン", () => {
      ...
      expect(actual.baseStats).to.have.all.keys("H", "A", "B", "C", "D", "S");
...
describe("Pokemon class (language: en)", () => {
  ...
  describe("constructor", () => {
    it("initializes correct properties for Alola Raichu", () => {
      ...
      expect(actual.name).to.equal("Raichu");
      expect(actual.formName).to.equal("Alola Form");
      expect(actual.type)
        .to.be.an("array")
        .that.has.lengthOf(2)
      ...
      expect(actual.megaEvolution).to.be.undefined;
      expect(actual.generation).to.be.undefined;
    });
    ...
    it("initializes correct properties for Venusaur", () => {
      ...
      expect(actual.localId).to.be.undefined;
      expect(actual.name).to.equal("Venusaur");
      expect(actual.formName).to.be.undefined;
      expect(actual.type)
        .to.be.an("array")
        .that.has.lengthOf(2)
